        ...
        builder: (context, AsyncSnapshot snapshot) {
          ...
          return Column(
            children: [
              ...
              Text(
                "Tanggal lahir Pegawai : ${snapshot.data.tanggallahirPegawai}",
                style: TextStyle(fontSize: 20),
              ), SizedBox(height: 20),
              Text(
                "Nomer Telepon Pegawai : ${snapshot.data.nomerteleponPegawai}",
                style: TextStyle(fontSize: 20),
              ), SizedBox(height: 20),
              Text(
              ...
              Text(
                "Password Pegawai : ${snapshot.data.passwordPegawai}",
                style: TextStyle(fontSize: 20),
              ),
              SizedBox(height: 20),
              Row(
